  ...
  try {
    ...
    if(path==="/api/bootstrap"&&req.method==="GET"){
      const [teams,fixtures,predictions,ranking]=await Promise.all([
        ...
        pool.query("SELECT id,home_team_id,away_team_id,stage,group_name,venue,kickoff_at,status,home_score,away_score FROM fixtures ORDER BY kickoff_at"),
